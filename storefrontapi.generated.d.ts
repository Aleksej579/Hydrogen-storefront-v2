...
export type ProductLeftImageFragment = Pick<
  StorefrontAPI.Product,
...
export type ProductLeftImageQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ProductLeftImageQuery = {
  products: {
    nodes: Array<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment ProductLeftImage on Product {\n    id\n    title\n    handle\n    description\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    images(first: 1) {\n      nodes {\n        id\n        url\n        altText\n        width\n        height\n      }\n    }\n  }\n  query ProductLeftImage ($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 2, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...ProductLeftImage\n      }\n    }\n  }\n': {
    return: ProductLeftImageQuery;
    variables: ProductLeftImageQueryVariables;
  };
